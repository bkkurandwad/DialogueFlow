...
//        String pswrd = intent.getStringExtra("pwd");
        ...
        email1 = findViewById(R.id.EmailAddress);
        ...
        submitButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String pswrd = password1.getText().toString();
    ...
    public void RegisterUser(String eid, String name, String number, String mail, String pswrd) {
        try {
            ...
            Toast.makeText(Eregdetails.this, "Trying to register", Toast.LENGTH_SHORT).show();
            call.enqueue(new Callback<Void>() {
                @Override
                public void onResponse(Call<Void> call, Response<Void> response) {
                    if (response.isSuccessful()) {
                        Log.d(TAG, "Register request sent to server successfully");
                        Toast.makeText(Eregdetails.this, "Registered the emp successfully", Toast.LENGTH_SHORT).show();
                        startActivity(new Intent(Eregdetails.this, Elogin.class));
                    } else {
                        Log.e(TAG, "Failed to send req to server. Error: " + response.message());
                        Toast.makeText(Eregdetails.this, "Bad response from server", Toast.LENGTH_SHORT).show();
                    }
                ...
                public void onFailure(Call<Void> call, Throwable t) {
                    Log.e(TAG, "F " + t.getMessage(), t);
                    Toast.makeText(Eregdetails.this, "Network error. Failed to register", Toast.LENGTH_SHORT).show();
                }
            });
        } catch (JSONException e) {
            Log.e(TAG, "Error creating JSON object", e);
            Toast.makeText(Eregdetails.this, "Error creating json", Toast.LENGTH_SHORT).show();
        }
    }
